...
TEST_CASE( "Null graph is connected", "[is_connected]" ) {
    Graph g;
    CHECK( is_connected(g) );
}

TEST_CASE( "Singleton graph is connected", "[is_connected]" ) {
    Graph g;
    g.add_vertex(0);
    CHECK( is_connected(g) );
}

TEST_CASE( "Two vertices with edge", "[is_connected]" ) {
    Graph g;
    g.add_edge(0, 1);
    CHECK( is_connected(g) );
}

TEST_CASE( "Two vertices without edge", "[is_connected]" ) {
    Graph g;
    g.add_vertex(0);
    g.add_vertex(1);
...
TEST_CASE( "Connected graph", "[is_connected]" ) {
    Graph g;
    g.add_edge(0, 1);
    g.add_edge(0, 2);
    g.add_edge(1, 3);
...
TEST_CASE( "Disconnected graph", "[is_connected]" ) {
    Graph g;
    g.add_edge(0, 1);
    g.add_edge(0, 2);
    g.add_edge(1, 3);
...
TEST_CASE( "Path in null graph doesn't exist", "[path_exists]" ) {
    Graph g;    
...
TEST_CASE( "Path for two vertices without edge", "[path_exists]" ) {
    Graph g;    
    g.add_vertex(0);
    g.add_vertex(1);
    CHECK_FALSE( path_exists(g, 0, 1) );
...
TEST_CASE( "Path for two vertices with edge", "[path_exists]" ) {
    Graph g;    
    g.add_edge(0, 1);
...
TEST_CASE( "Path in disconnected graph", "[path_exists]" ) {
    Graph g;    
    g.add_edge(0, 1);
    g.add_edge(1, 2);
    g.add_edge(2, 3);
...
TEST_CASE( "Reverse path", "[path_exists]" ) {
    Graph g;    
    g.add_edge(0, 1);
    g.add_edge(1, 2);
    g.add_edge(2, 3);
